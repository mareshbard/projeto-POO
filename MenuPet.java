...
public class MenuPet {
    ...
    private Animal criarAnimal() {
        ...
        switch(op) {
            ...
            case 2:
                return new Gato(idAuto++, nomeAnimal, donoAnimal, racaAnimal); 
            case 3: 
    ...
    private void menuAposCadastro(Animal animal) {
        ...
        do {
            ...
            switch(op) {
                case 1: editarAnimal(); break;
                case 2: excluirAnimal(); return;
    ...
    private void excluirAnimal() {
        System.out.print("Digite o ID do animal a excluir: ");
        int id = in.nextInt();
        in.nextLine();
